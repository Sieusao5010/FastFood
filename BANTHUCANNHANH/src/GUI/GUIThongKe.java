...
public class GUIThongKe extends JPanel {
    ...
    public GUIThongKe() throws Exception {
        ...
        tabs.addTab("Thống kê tổng quát", tkH);
        tabs.addTab("Món ăn", null);
        tabs.addTab("Nhân viên", null);
        tabs.addTab("Khách hàng", null);
        tabs.addTab("Nhà cung cấp", null);
...
//    Này là panel tổng trong thống kê tổng quát
    private void setDataToPanelTong() {
        ...
        plThongKeSoLuong.add(getJPanelTong("MÓN ĂN", "", qlmaBUS.getMonAnDTO().size(), Color.BLUE));
        plThongKeSoLuong.add(getJPanelTong("NHÂN VIÊN", "", qlnvBUS.getNhanVienDTO().size(), Color.BLUE));
        plThongKeSoLuong.add(getJPanelTong("KHÁCH HÀNG", "", qlkhBUS.getKhachHangDTO().size(), Color.BLUE));
        plThongKeSoLuong.add(getJPanelTong("NHÀ CUNG CẤP", "", qlnccBUS.getNhaCungCapDTO().size(), Color.BLUE));
    }
