...
public class GUImenu extends JFrame{
    ...
    private String arr_listmenu[]={"Món ăn","Hóa đơn","Bán hàng","Nguyên liệu","Nhập hàng","Công thức","Hóa đơn nhập",
        "Khuyến mãi","Nhà cung cấp","Nhân viên","Khách Hàng","Phân quyền","Tài khoản","Thống kê"};
    //Tạo mảng icon cho menuleft
    private String arr_icon[]={"src/Images/Icon/outline_store_black_24dp.png","src/Images/Icon/outline_receipt_black_24dp.png","src/Images/Icon/outline_store_black_24dp.png",
        "src/Images/Icon/outline_shopping_cart_black_24dp.png","src/Images/Icon/outline_store_black_24dp.png","src/Images/Icon/outline_receipt_black_24dp.png",
        "src/Images/Icon/outline_receipt_black_24dp.png","src/Images/Icon/outline_wysiwyg_black_24dp.png","src/Images/Icon/outline_accessibility_new_black_24dp.png",
        "src/Images/Icon/outline_accessibility_new_black_24dp.png","src/Images/Icon/outline_accessibility_new_black_24dp.png","src/Images/Icon/outline_manage_accounts_black_24dp.png",
        "src/Images/Icon/outline_supervisor_account_black_24dp.png","src/Images/Icon/outline_analytics_black_24dp.png"};
